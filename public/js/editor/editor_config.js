...
(function (){
    var tmp = window.location.pathname,
        URL= '/js/editor/';//这里你可以配置成ueditor目录在您网站中与根目录之间的相对路径或者绝对路径（指以http开头的绝对路径）
    UEDITOR_CONFIG = {
        ...
        toolbars: [
            ['Undo','Redo','|',
             ...
             'InsertImage','Emotion','InsertVideo','Map','GMap','InsertFrame','|',
             'Horizontal','Date','Time','Spechars','|',
             'RemoveFormat'],
            ['Paragraph','RowSpacing','LineHeight','FontFamily','FontSize','|',
             'HighlightCode','|',
        ...
        ,
        initialContent: '<span>欢迎</span>',  //初始化编辑器的内容
